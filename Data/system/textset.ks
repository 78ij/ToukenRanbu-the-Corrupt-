...
;对话文字框
@macro name=advl
[position layer=%layer|message0 page=fore visible=true opacity=255 top=372 height=168 left=0 width=960 marginl=20 margint=0 marginr=10 marginb= 0 frame=%frame| ]
@endmacro
